...
titanic = media.Movie("Titanic",
                      "195 minutes",
                      "19 December 1997",
                      ("Epic Romance set against the ill-fated voyage of "
                       "the RMS Titanic"),
                      "James Cameron",
...
the_wolf_of_wall_street = media.Movie("The Wolf of Wall Street ",
                                      "180 minutes",
                                      "17 December 2013",
                                      ("Biographical film that recounts"
                                       "Belfort's perspective on his career"
                                       "as a stockbroker in New York City"),
                                      "Martin Scorsese",
                                      ("https://upload.wikimedia.org/wikipedia"
                                       "/en/d/d8/The_Wolf_of_Wall_Street_"
                                       "%282013%29.png"),
                                      ("https://www.youtube.com/watch?v=iszwuX"
                                       "1AK6A"),
                                      "R")
# The Mummy
the_mummy = media.Movie("The Mummy",
                        "125 minutes",
                        "7 May 1999",
                        ("Adventurer Rick O'Connell travels to Hamunaptra,"
                         "the city of the dead, with an archaeologist and her"
                         "brother when  accidentally they awaken Imhotep,"
                         "a high priest from the reign of the pharaoh Seti."),
                        "Stephen Sommers",
...
mission_impossible_ghost_protocol = media.Movie(("Mission: Impossible Ghost"
                                                "Protocol "),
                                                "133 minutes",
                                                "16 December 2011",
                                                ("After been blamed for a"
                                                 "terrorist attack, IMF agency"
                                                 "go into ghost protocol and"
                                                 "try to stop a nuclear"
                                                 "attack"),
                                                "Brad Bird",
                                                ("https://upload.wikimedia."
                                                 "org/wikipedia/en/b/b5/"
                                                 "Mission_impossible_ghost_"
                                                 "protocol.jpg"),
...
meet_the_fockers = media.Movie("Meet the Fockers",
                               "115 minutes",
                               "22 December 2004",
                               ("Gaylord  Focker  and his fiancee Pam Byrnes"
                                "decide to introduce their parents to each"
                                "other."),
                               "Jay Roach",
                               ("https://upload.wikimedia.org/wikipedia/en/2/"
                                "27/Meet_The_Fockers.jpg"),
...
spider_man = media.Movie("Spider-Man",
                         "121 minutes",
                         "3 May 2002",
                         ("Peter Parker, a high school student living in New "
                          "York City, who turns to crimefighting as Spider-Man"
